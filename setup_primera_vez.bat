@echo off
title Configuracion inicial - Dashboard Auditorias

echo.
echo ========================================================
echo      CONFIGURACION INICIAL (Solo una vez)
echo ========================================================
echo.
...
echo.
echo Se conectara al repositorio:
echo   %REPO_URL%
echo.
...
echo (Se te pedira usuario y contrasena/token de GitHub)
echo.

git -C "%CARPETA%" add .
git -C "%CARPETA%" commit -m "Configuracion inicial del dashboard"
...
if errorlevel 1 (
    ...
    echo.
    echo Si te pide contrasena, debes usar un TOKEN de GitHub:
